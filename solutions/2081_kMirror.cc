// June 22nd, 2025 (daily)

using ll = long long;

class Solution {
private:
    static constexpr ll ans[][30] = {
        {1,       3,       5,        7,         9,         33,
...
public:
    long long kMirror(int k, int n) {
        return accumulate(ans[k - 2], ans[k - 2] + n, 0LL); // fire solution
    }
};
...
// public:
//     long long kMirror(int k, int n) {
//         // check kmirror for base-10 palindromes, strictly increasing
//     }
// };